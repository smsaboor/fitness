...
class StatesNews extends StatefulWidget {
  int colorVal;
  StatesNews(this.colorVal);

  _StatesNewsState createState() => _StatesNewsState();
}

class _StatesNewsState extends State<StatesNews>
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Padding(
        padding: EdgeInsets.only(top: 10.0, left: 8.0, right: 0.0),
